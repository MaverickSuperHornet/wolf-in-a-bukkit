...
public enum Art 
    ...
    STAGE     (16,2,2),
    VOID      (17,2,2),
    SKULL_AND_ROSES(18,2,2),//#ocdtrigger 
    WITHER    (19,2,2),
    FIGHTERS  (20,4,2),
    POINTER   (21,4,4),
    PIGSCENE  (22,4,4),
    BURNINGSKULL(23,4,4),// and another one :-)
    SKELETON  (24,4,3),
    DONKEYKONG(25,4,3);
    ...
    static
        ...
        for(Art pixely : values())
            ...
            NAME_MAP.put(pixely.toString().toLowerCase().replaceAll("_",""),pixely);
            }
        }
    ...
    public static Art getByName(String which)
        ...
        return NAME_MAP.get(which.toLowerCase.replaceAll("_",""));        
        }
