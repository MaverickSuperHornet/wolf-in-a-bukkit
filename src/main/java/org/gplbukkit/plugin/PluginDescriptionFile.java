...
import org.gplbukkit.command.CommandExecutor;
import org.gplbukkit.command.PluginCommand;
import org.gplbukkit.plugin.Plugin;
import org.gplbukkit.plugin.java.JavaPlugin;
import org.gplbukkit.permissions.Permissible;
import org.gplbukkit.permissions.Permission;
import org.gplbukkit.permissions.PermissionDefault;
...
public final class PluginDescriptionFile {
     ...
     *     itself.
     * <li>If your namespace is <code>org.gplbukkit.plugin</code>, and your class
     *     file is called <code>MyPlugin</code> then this must be
     *     <code>org.gplbukkit.plugin.MyPlugin</code>
     * <li>No plugin can use <code>org.gplbukkit.</code> as a base package for
     ...
     * <p>
     * Example:
     * <blockquote><pre>main: org.gplbukkit.plugin.MyPlugin</pre></blockquote>
     *
    ...
    private void loadMap(Map<?, ?> map) throws InvalidDescriptionException {
        ...
        try {
            ...
            if (main.startsWith("org.gplbukkit.")) {
                throw new InvalidDescriptionException("main may not be within the org.gplbukkit namespace");
            }
        } catch (NullPointerException ex) {
