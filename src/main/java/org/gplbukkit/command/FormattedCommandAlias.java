...
import org.gplbukkit.event.player.PlayerCommandPreprocessEvent;
import org.gplbukkit.event.server.RemoteServerCommandEvent;
import org.gplbukkit.event.server.ServerCommandEvent;
        ...
        for (String formatString : formatStrings) {
            try {
                ...
                if (throwable instanceof IllegalArgumentException) {
                    ...
                    sender.sendMessage(org.gplbukkit.ChatColor.RED + "An internal error occurred while attempting to perform this command");
                }
                return false;
            }
        }
