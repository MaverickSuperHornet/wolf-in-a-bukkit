...
public interface HelpMap {
     ...
     * org.gplbukkit.command.PluginCommand} who's executor derives from {@code
     * commandClass} base class.
     *
     * @param commandClass The class for which the custom HelpTopicFactory
     *     applies. Must derive from either {@link org.gplbukkit.command.Command}
     *     or {@link org.gplbukkit.command.CommandExecutor}.
     ...
     * {@link org.gplbukkit.command.Command} instead of {@link
     * org.gplbukkit.command.PluginCommand} will need to check this collection in
